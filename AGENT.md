...
- **Comprehensive Guidelines**: See **[`docs/agents/README.md`](docs/agents/README.md)** for:
  1. **Core Architectural Tenets**: Read-only design, zero-runtime static binary footprint, zero disk state, bounded concurrency budgets.
  2. **Mandatory Documentation Maintenance Matrix**: Protocols for keeping documentation in sync whenever code is changed.
  3. **Pre-Commit Verification Checklist**: Test suites, web bundling, and architecture synchronization.
  4. **Frontend Architecture & Code Map**: Section index of `web/index.html` and ES module catalog of `web/src/`.
