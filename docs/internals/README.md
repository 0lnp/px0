...
- **[Git Awareness & Diffing](git-integration.md)**: Read-only CLI shell-out architecture, concurrent status generation with indexing, ancestor folder dirty propagation, and gutter diff parsing.
