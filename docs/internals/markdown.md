...
- The selection bar and right-click menu actions (Copy for Agent, Edit with Agent, Find Usages) do not act on text selected in the preview. Switch to Source to edit.
